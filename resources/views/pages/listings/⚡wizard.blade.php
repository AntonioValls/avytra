        ...
        @if ($step === 2)
            <section class="flex flex-col gap-6">
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <flux:select variant="listbox" wire:model="business.employee_range" :label="__('Employees')" :placeholder="__('Choose a range')">
                    ...
                    <flux:accordion.item :heading="__('Legal and web details (optional)')">
                        <div class="flex flex-col gap-6 pt-4">
                            ...
                            <div class="grid gap-6 sm:grid-cols-2">
                                ...
                                <flux:select variant="listbox" wire:model="business.legal_form" :label="__('Legal form')" :placeholder="__('Choose a legal form')">
                            ...
                            <div class="grid gap-6 sm:grid-cols-2">
                                ...
                                <flux:select variant="listbox" wire:model="business.website_visibility" :label="__('Website visibility')">
