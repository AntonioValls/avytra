...
**No añadir ni sustituir dependencias sin aprobación explícita del propietario** y sin registrar un ADR en `docs/DECISIONS.md`. Pendientes de aprobación en su fase: `maplibre-gl` (Phase 5), `spatie/laravel-medialibrary` (Phase 6).
