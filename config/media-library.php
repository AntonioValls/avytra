...
use App\Support\Media\BusinessPathGenerator;
...
return [
     ...
     */
    // AVYTRA: originals are private; only WebP conversions are public (docs/16, docs/17).
    'disk_name' => env('MEDIA_ORIGINALS_DISK', 'local'),
     ...
     */
    // Media Library Pro is not installed; the class name is kept as a string so static analysis passes.
     ...
     */
    'path_generator' => BusinessPathGenerator::class,
